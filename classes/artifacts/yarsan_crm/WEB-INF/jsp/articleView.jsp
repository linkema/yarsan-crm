...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath%>/editormd/editormd.min.css"/>
</head>
<body>
    ...
    <div style="border-left: 3px solid #f44336;">
        <br/>
         <div style="margin-bottom:8px;">
             &nbsp;&nbsp;&nbsp;&nbsp;<strong style="font-size:18px;">创建人：&nbsp;&nbsp;</strong>
                            ...
                            <div>
                                ...
                                <div class="replycontainer layui-hide" style="margin-left: 61px;">
                                    <form action="<%=basePath%>/article/saveReply.action" method="post" class="layui-form">
                                        <input name="lr_for_article_id" id="lr_article_id" value="${article.r_id}" hidden="hidden"/>
                                        <input name="lr_name" id="lr__name" value="${sessionScope.name}" hidden="hidden"/>
                                        <input name="lr_date" id="lr__date" value="<%=nowDate%>" hidden="hidden"/>
                                        <input name="lr_for_name" id="lr___name" value="${words.lw_name}" hidden="hidden"/>
                                        <input name="lr_for_words" id="lr_words" value="${words.lw_id}" hidden="hidden"/>
                                        <input name="lr_for_reply" id="lr_reply" value="${reply.lr_id}" hidden="hidden"/>
                                        <div class="layui-form-item">
                                            <textarea name="lr_content" id="lr__content" lay-verify="replyContent" placeholder="请输入回复内容" class="layui-textarea" style="min-height:80px;"></textarea>
                                        </div>
                                        <div class="layui-form-item">
                                            <button id="reply_Btn" class="layui-btn layui-btn-mini" lay-submit="formReply" lay-filter="formReply">提交</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    $("#replyBtn").click(function(){
        ...
        $.ajax({
            url: '<%=basePath%>/article/saveReply.action',
            type: 'POST',
            data: [{
