        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="login-panel panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="${pageContext.request.contextPath}/user/checkLogin.action" method="post">
                        <fieldset>
                            ...
                            <input type="button" value="注册" onclick="window.location.href='${pageContext.request.contextPath}/user/regist.action'" class="btn btn-primary form-control">
                        </fieldset>
                    </form>
                </div>
            </div>
