...
<div class="container" style="width:80%;">
    <div style="margin-top: 60px;">
        <fieldset class="layui-elem-field layui-field-title">
            <legend style="margin-left: 20px;padding: 0 10px;text-align: left;width: 100px;border-bottom: none;"><strong>写备注</strong>
            </legend>
        </fieldset>
    </div>
    <br/>
    ...
    <div class="layui-form">
        <form action="<%=basePath%>/" method="post">
            <div class="layui-inline" style="margin-left: -10px;">
                <label class="layui-form-label" style="padding-left: 0;"><strong>客户姓名</strong></label>
                ...
                <label class="layui-form-label" style="margin-left:169px;padding-left: 0;"><strong>创建日期</strong></label>
            ...
            <div class="layui-inline" style="margin-left: -10px;padding-left: 0;">
                <label class="layui-form-label" style="padding-left: 0;"><strong>日志简介</strong></label>
                <div class="layui-input-inline" style="margin-left: -6px;width: 275px;">
                    <input type="text" name="r_summary" id="r_summary" placeholder="请用简短的文字总结日志内容" class="layui-input"/>
                </div>
            </div>
            <br/>
            <br/>
...
<script type="text/javascript">
    ...
    $("#publishBtn").click(function(){
        ...
        var r_status = 0;
        $.ajax({
            url: '<%=basePath%>/article/saveArticle.action',
            type: 'POST',
            data: {
                r_id: r_id,
                r_author: r_author,
