...
import mlk.core.dao.ArticleDao;
import mlk.core.service.ArticleService;
...
public class ArticleServiceImpl implements ArticleService {
     ...
     * @return 分页查询的结果
     */
    public Page<Article> findByPage(int pageCode, int pageSize, Map<String, Object> conMap) {
        HashMap<String,Object> map = new HashMap<String,Object>();
        Page<Article> pageBean = new Page<Article>();

        //获取Controller层封装的状态码
        Integer goId = (Integer)conMap.get("goId");

        //封装数据
        pageBean.setPage(pageCode);
...
//        }
        ...
        conMap.put("size",pageBean.getSize());

        List<Article> conList = articleMapper.findConByPage(conMap);
        pageBean.setRows(conList);
        return pageBean;
    }
