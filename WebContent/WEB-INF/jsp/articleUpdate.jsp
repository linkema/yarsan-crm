    ...
    <div class="layui-form">
        <form>
            <div class="layui-inline" style="margin-left: -10px;">
                <label class="layui-form-label" style="padding-left: 0;"><strong>日志编号</strong></label>
                ...
                <label class="layui-form-label" style="margin-left: 157px;width:90px;"><strong>客户姓名</strong></label>
            ...
            <br/>
            <br/>
            <label><strong>备注日志内容</strong></label>
            <!-- 加载Markdown富文本容器 -->
...
<script type="text/javascript">
    ...
    $("#verifyBtn").click(function(){
        ...
        var r_status = 0;
        $.ajax({
            url: '<%=basePath%>/article/update.action',
            type: 'POST',
            data: {
                r_id: r_id,
                r_author: r_author,
